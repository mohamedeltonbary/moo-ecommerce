...
const Payment = () => {
    ...
    return (
        <div className="w-full md:w-1/2 mx-auto mt-10 bg-white shadow-lg rounded-xl p-6">
            <h1 className="font-bold text-2xl text-center mb-6 text-orange-700">Payment</h1>
            ...
            <div className="flex justify-between">
                ...
                <Button    onClick={onlinePayment} className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-lg">
                    Online Payment
                </Button>
            </div>
        </div>
